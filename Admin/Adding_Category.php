...
$isUpdated = 0;
if ($id !="") {
    $sql = "select CatID, CatName from category where CatID = $id";
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="fid" name="fid" value="<?php echo $CatID?>" <?php if ($isUpdated == 1) echo "readonly";?> placeholder="category id..">
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="fname" name="fname" value="<?php echo $CatName?>" placeholder="category name..">
    </div>
  </div>
